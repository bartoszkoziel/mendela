...
function regon() {
   let value = document.getElementById("REGON").value
   let valueStr = value.toString()

   if (valueStr.length == 9) {
      // REGON 9-cyfrowy
      let suma =
         parseInt(valueStr[0]) * 8 +
         parseInt(valueStr[1]) * 9 +
         parseInt(valueStr[2]) * 2 +
         parseInt(valueStr[3]) * 3 +
         parseInt(valueStr[4]) * 4 +
         parseInt(valueStr[5]) * 5 +
         parseInt(valueStr[6]) * 6 +
         parseInt(valueStr[7]) * 7

      if (suma % 11 == parseInt(valueStr[8])) {
         console.log("true")
      } else {
         console.log("false")
      }
      ...
      // REGON 14-cyfrowy
      let suma =
         parseInt(valueStr[0]) * 2 +
         parseInt(valueStr[1]) * 4 +
         parseInt(valueStr[2]) * 8 +
         parseInt(valueStr[3]) * 5 +
         parseInt(valueStr[4]) * 0 +
         parseInt(valueStr[5]) * 9 +
         parseInt(valueStr[6]) * 7 +
         parseInt(valueStr[7]) * 3 +
         parseInt(valueStr[8]) * 6 +
         parseInt(valueStr[9]) * 1 +
         parseInt(valueStr[10]) * 2 +
         parseInt(valueStr[11]) * 4 +
         parseInt(valueStr[12]) * 8

      if (suma % 11 == parseInt(valueStr[13])) {
         console.log("true")
      } else {
         console.log("false")
      }
